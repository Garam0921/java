package Java0402Collection.Java0402CollectionList;
...
public class ArrayListMethod {
    public static void main(String[] args) {
        // 인터페이스 왜 쓰지? 기능 구현!!!!
        List<Integer> aList1 = new ArrayList<Integer>();  //  ※되게 중요!! 리스트를 설명하시오 (사용법은 몰라도) 리스트는 인터페이스이기 떄문에 구현체가 필요하다. 구현체 종류는 3개 1. ArrayList, 2. Vector, 3.Linked
        ...
        //#5. set(int index, E element)  ※(set의 의미는 update)
        aList3.set(1,5);
        aList3.set(3,6);
        ...
        //#13-1. toArray(T[] t) -->  T[]   ※(특정 Array를 지정 해줄 수 있는 문법[0])
