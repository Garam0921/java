...
-- 순서가 중요. select from where 순서 기억필요
...
where 도시 = '서울특별시'
order by 마일리지 desc
limit 10, 10; --내림차순이므로 상위 10명을 제외하고 그 이후 10명의 데이트를 읽는 방법임.


select 도시 from 고객; --고객들이 위치한 도시 정보만 보고 싶은 경우
